...
import { MELD, MELDPublicSale, MELDSeedSale } from '../constant';
...
import { MELDPublicSale__factory as MELDPublicSaleFactory } from '../contracts/factories/MELDPublicSale__factory';
...
export const PublicSale = (props: Props) => {
    ...
    const seedSaleInstance = MELDPublicSaleFactory.connect(MELDPublicSale, library);
